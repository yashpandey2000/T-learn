...
import in.co.tlearn.ctl.BaseCtl;
import in.co.tlearn.ctl.ORSView;
...
public class ServletUtility {
     ...
     * @param request
     */
    public static void setDto(BaseBean dto, HttpServletRequest request) {
    ...
    public static BaseBean getDto(HttpServletRequest request) {
        return (BaseBean) request.getAttribute("dto");
    }
