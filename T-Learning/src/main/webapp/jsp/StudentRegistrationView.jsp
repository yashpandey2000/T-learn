<%@page import="in.co.tlearn.ctl.StudentRegistrationCtl"%>
...
<div class="header">
	...
	<div>
		...
		<main>
		<form action="<%=ORSView.STUDENT_REGISTRATION_CTL%>" method="post">
				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							<h3 class="text-center default-text text-primary pb-2"><u>Student Registration</u>
							</h3>
							<!--Body-->
							<div>
...
<div class="col-sm-12">
      <div class="input-group">
      <label><b>Insti</b></label>
	<span style="color: red;">*</span>  &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <div class="input-group-prepend">
          <div class="input-group-text"><i class="fa fa-university grey-text" style="font-size: 1rem;"></i> </div>
        </div>
        <input type="text"  name="in" class="form-control" placeholder="enter Institute" value="<%=DataUtility.getStringData(dto.getInstitute())%>">
      </div>
    </div>	
	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("in", request)%></font></br>
...
<br>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=StudentRegistrationCtl.OP_SIGN_UP%>"> <input
									type="submit" name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px"
									value="<%=StudentRegistrationCtl.OP_RESET%>">
							</div>
						</div>
