...
<%@page import="in.co.tlearn.ctl.TeacherandStudentCtl"%>
...
<div>
					...
					<div class="card">
						<div class="card-body">
							...
							<div>
								...
								<jsp:useBean id="dto" class="in.co.tlearn.bean.UserBean" scope="request"></jsp:useBean>
								<H6 align="center">
									<%
	...
	<div class="col-sm-12">
      ...
      <label><b>Email Id</b></label>
        ...
        <input type="text" class="form-control" name="loginid" placeholder="Enter emailid" value="<%=DataUtility.getStringData(dto.getEmailid())%>">
      </div>
    </div>
	...
	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("password", request)%></font></br>	</br>						
							...
							<div class="text-center">
								...
								<input type="submit"
									...
									value="<%=TeacherandStudentCtl.OP_SIGN_UP%>">
							</div>
