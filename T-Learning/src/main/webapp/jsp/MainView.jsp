    ...
    <div class="jumbotron jumbotron-fluid p-3 " style="background-image: linear-gradient( rgba(0, 0, 0, 0.600) ,  rgba(0, 0, 0, 0.600)),
      ...
      <div class="container">
        <div class="row ">
          ...
          <div class="col-md-4 bg-light rounded-circle">
                ...
                <div class="col-11 mx-auto position-relative">
                  <div class="row align-items-center">
                    ...
                    <div class="col-lg-7">
                      ...
                      <p class="text-white text-center mb-3 mb-lg-0">Speedily say has suitable disposal add boy. On forth doubt miles of child. Exercise joy man children rejoiced. Yet uncommonly his ten who diminution astonished.</p>
                    </div>
                    <!-- Content and input -->
